...
export default function JoinTripPage() {
  ...
  const handleJoin = () => {
    if (session) {
      // Already signed in — go to trip
      router.push(`/trip/trip-tokyo-2026`);
    } else {
      // Sign in first, then redirect to this join page
      signIn("apple", { callbackUrl: `/join/${code}` });
    }
  };
    ...
    <div className="min-h-screen flex items-center justify-center px-6">
      ...
      >
        ...
        <div className="flex justify-center -space-x-2 mb-8">
          ...
          <div className="w-10 h-10 rounded-full bg-[var(--bg-tertiary)] border-2 border-white dark:border-black flex items-center justify-center">
